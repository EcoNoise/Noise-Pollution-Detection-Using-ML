...
export const getHealthImpactDescription = (impact: string): string => {
  const descriptions: { [key: string]: string } = {
    'Ringan': 'Dampak minimal terhadap kesehatan. Tingkat kebisingan masih dalam batas normal.',
    'Sedang': 'Dapat menyebabkan gangguan ringan seperti kesulitan konsentrasi.',
    'Tinggi': 'Berisiko menyebabkan stres, gangguan tidur, dan penurunan produktivitas.',
    'Berbahaya': 'Sangat berisiko terhadap kesehatan. Dapat menyebabkan gangguan pendengaran dan masalah kesehatan serius.',
    
    // Backward compatibility
    'Low': 'Dampak minimal terhadap kesehatan. Tingkat kebisingan masih dalam batas normal.',
    'Moderate': 'Dapat menyebabkan gangguan ringan seperti kesulitan konsentrasi.',
    'High': 'Berisiko menyebabkan stres, gangguan tidur, dan penurunan produktivitas.',
    'Severe': 'Sangat berisiko terhadap kesehatan. Dapat menyebabkan gangguan pendengaran dan masalah kesehatan serius.',
  };
