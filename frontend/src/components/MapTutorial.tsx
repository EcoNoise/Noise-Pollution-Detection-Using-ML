  ...
  const tutorialSteps: TutorialStep[] = [
    {
      ...
      description:
        "Mari jelajahi fitur-fitur yang tersedia untuk memantau tingkat kebisingan di sekitar Anda.",
    ...
    },
    {
      ...
      description:
        "Gunakan kotak pencarian untuk menemukan lokasi tertentu dengan cepat dan mudah.",
    ...
    },
    {
      ...
      description:
        "Klik tombol ini untuk menambahkan area kebisingan baru. Anda bisa upload file audio untuk analisis otomatis!",
    ...
    },
    {
      ...
      title: "Filter Data",
      description:
        "Gunakan filter untuk menyaring data berdasarkan tingkat kebisingan, sumber, atau dampak kesehatan.",
    ...
    },
    {
      ...
      title: "Legenda Peta",
      description:
        "Lihat legenda untuk memahami arti warna-warna pada peta dan tingkat kebisingan.",
    ...
    },
    {
      ...
      title: "Lokasi Saya",
      description:
        "Klik untuk menemukan lokasi Anda saat ini dan melihat tingkat kebisingan di sekitar.",
